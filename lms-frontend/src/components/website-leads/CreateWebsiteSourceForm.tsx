...
const LMS_FIELD_OPTIONS = [
  ...
  { value: 'services', label: 'Interested Services' },
  { value: 'notes', label: 'Requirement / Notes' },
  { value: 'metadata.leadType', label: 'Lead Type' },
  { value: 'metadata.contactMethod', label: 'Preferred Contact Method' },
  { value: 'metadata.bestTime', label: 'Best Time to Contact' },
  { value: 'metadata.doNotContact', label: 'Do Not Contact' },
  { value: 'metadata.emailOptIn', label: 'Email Opt-in' },
  ...
  { value: 'address.postalCode', label: 'Postal / Zip Code' },
  { value: 'address.country', label: 'Country' },
  { value: 'industry', label: 'Industry' },
  { value: 'companySize', label: 'Company Size' },
  { value: 'budget', label: 'Budget' },
  { value: 'leadValue', label: 'Expected Deal Value' },
  ...
  { value: 'metadata.reminder', label: 'Reminder' },
  { value: 'tags', label: 'Tags' },
  { value: 'metadata.additionalInfo', label: 'Additional Information' },
  { value: 'stageProbability', label: 'Stage Probability' },
  ...
  { value: 'lastCallDate', label: 'Last Call Date' },
